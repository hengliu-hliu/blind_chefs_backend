...
SECRET_KEY = 'django-insecure-i+g_aousxjt_ab5y#h#-t&ab8)p=p92mmm$rhp0hutyl7ub-z6'
...
ROOT_URLCONF = 'blind_chefs_backend.urls'
...
WSGI_APPLICATION = 'blind_chefs_backend.wsgi.application'
